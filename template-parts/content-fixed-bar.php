...
if ( 'disabled' === get_theme_mod( 'latest_fixed_bar', 'enabled' ) ) {
	return;
}
				...
				if( $prevPost ) {
					...
					echo '<div class="fixed-nav">';
						...
						echo '<div class="fixed-post-text">';
							echo '<span>' . esc_html__( 'Next', 'latest' ) . '</span>';
			...
			if ( $fixed_posts->have_posts() ) :
				...
				<div class="fixed-nav">
					...
					<?php if ( has_post_thumbnail() ) { ?>
						<a class="fixed-image" href="<?php the_permalink(); ?>" rel="bookmark"><?php the_post_thumbnail( 'latest-fixed-thumb' ); ?></a>
					<?php } ?>

					<div class="fixed-post-text">
						<span><?php esc_html_e( 'Featured', 'latest' ); ?></span>
		...
		<?php if ( has_nav_menu( 'secondary' ) ) { ?>
			<li>
				<a class="drawer-open-toggle" href="#">
					<span><i class="fa fa-search"></i> <?php esc_html_e( 'Explore', 'latest' ); ?></span>
				</a>
			</li>
		<?php } ?>
		<li class="back-to-top">
			<a href="#">
				<span><i class="fa fa-bars"></i> <?php esc_html_e( 'Menu', 'latest' ); ?></span>
			</a>
		</li>
