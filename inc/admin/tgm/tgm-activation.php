 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Latest
...
add_action( 'tgmpa_register', 'latest_register_required_plugins' );
 ...
 */
function latest_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'latest_wpforms_shareasale_id' );

function latest_wpforms_shareasale_id( $shareasale_id ) {
